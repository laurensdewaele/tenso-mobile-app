...
abstract class Staatliches {
  static const TextStyle countdownTimer = TextStyle(
      fontFamily: 'Staatliches', fontSize: 700, color: styles.Colors.white);
  static const TextStyle countdownTimerTranslucent = TextStyle(
      fontFamily: 'Staatliches',
      fontSize: 700,
      color: styles.Colors.whiteTranslucent);
  ...
  static const TextStyle mGray = TextStyle(
      fontFamily: 'Staatliches', fontSize: 20, color: styles.Colors.gray);
  ...
  static const TextStyle sGray = TextStyle(
      fontFamily: 'Staatliches', fontSize: 18, color: styles.Colors.gray);
...
abstract class Lato {
  ...
  static const TextStyle protocolDescriptionBlack = TextStyle(
    height: 1.3,
    fontFamily: 'Lato',
    fontSize: 16,
    color: styles.Colors.black,
  );
  static const TextStyle protocolDescriptionBlue = TextStyle(
    height: 1,
    fontFamily: 'Lato',
    fontSize: 16,
